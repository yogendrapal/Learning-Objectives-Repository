...
public class DomainController {
	...
	/*
	 * Read domain for the given domain id
	 */
	...
	/*
	 * Delete domain for the given domain id
	 */
	...
	/*
	 * Create domain and also relationship between domain and field for the given
	 * field id
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer')")
	...
	/*
	 * Read list of fields for the given domain id
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer','Creator')")
	...
	/*
	 * Read domain corresponding to the given field id
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer','Creator')")
	...
	/*
	 * Update domain for the given field id
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer')")
	...
	/*
	 * Update relationship between the given domain id and field id
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer')")
	...
	/*
	 * Delete domain for the given field id
	 */
	@PreAuthorize("hasAnyRole('Admin')")
