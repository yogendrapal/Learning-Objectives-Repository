...
public class TaxonomyController {
	...
	/*
	 * Internal class to accept taxonomyName and it's description in a single object
	 * in string format
	 */
	...
	/*
	 * Get taxonomy for the given taxonomy id
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer','Creator')")
	...
	/*
	 * Create taxonomy related to the given learning objective
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer')")
	...
	/*
	 * Get list of learning objectives for the given taxonomy id
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer','Creator')")
	...
	/*
	 * Get taxonomy for the given learning objective
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer','Creator')")
	...
	/*
	 * Update taxonomy for the given learning objective
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer')")
	...
	/*
	 * update relationship between the given taxonomy and learning objective
	 */
	@PreAuthorize("hasAnyRole('Admin','Reviewer')")
	...
	/*
	 * Delete taxonomy for the given taxonomy id
	 */
	...
	/*
	 * Delete taxonomy for the given learning objective id
	 */
	@PreAuthorize("hasAnyRole('Admin')")
